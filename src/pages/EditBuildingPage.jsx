...
const EditBuildingPage = ({ updateBuildingSubmit }) => {
  ...
  const [rent, setRent] = useState(building.rent);
  const [companyName, setCompanyName] = useState(building.company.name);
  ...
  const submitForm = (e) => {
    ...
    updateBuildingSubmit(updatedBuilding);

    toast.success("Building Updated Successfully");

    return navigate(`/buildings/${id}`);
  };
